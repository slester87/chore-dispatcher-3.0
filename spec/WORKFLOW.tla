...
NextMap ==
  [s \in States |->
    IF s = PLAN THEN PLAN_REVIEW
    ELSE IF s = PLAN_REVIEW THEN PLAN_READY
    ELSE IF s = PLAN_READY THEN WORK
    ELSE IF s = WORK THEN WORK_REVIEW
    ELSE IF s = WORK_REVIEW THEN WORK_DONE
    ELSE WORK_DONE]
